...
input_map_move = {
    **input_map_common,
    ...
    "mm":         ("click", actions.user.parrot_rig_click),
    # Two boosts, both locking the heading: shush ramps for distance, palate
    # is immediate for a gap you can see. hiss is the one deceleration, so it
    # never bursts in here.
