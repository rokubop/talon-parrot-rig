...
from ..parrot_rig_settings import (
    ...
    PICKER_RADIUS, PICKER_SECTION_GAP, PICKER_TEXT_COLOR, PICKER_TEXT_SIZE,
    PICKER_TILE_ALT_COLOR, PICKER_TILE_COLOR, PICKER_TILE_EXIT_COLOR,
    PICKER_TILE_GAP, PICKER_TILE_HEIGHT, PICKER_TILE_HOVER_COLOR,
    PICKER_TILE_SELECTED_COLOR, PICKER_TILE_WIDTH, PICKER_TITLE_BAR_COLOR,
    PICKER_TITLE_SIZE,
)
...
def tile(label, noise=None, value=None, selected=False, on_click=None,
    ...
    return div(
        ...
        text(noise, color=PICKER_NOISE_COLOR, font_size=PICKER_TEXT_SIZE,
             font_family="monospace", text_align="center") if noise else None,
        text(label, color=PICKER_TEXT_COLOR, font_size=PICKER_TEXT_SIZE,
             font_weight="bold", text_align="center"),
        text(value, color=PICKER_HEADER_COLOR, font_size=PICKER_TEXT_SIZE,
...
def section(title, tiles, columns: int = PICKER_COLUMNS, fixed: bool = False,
    ...
    return div(gap=PICKER_HEADER_GAP)[
        text(title, color=PICKER_HEADER_COLOR, font_size=PICKER_TEXT_SIZE,
...
def _empty(message):
    ...
    return div(min_height=PICKER_TILE_HEIGHT, justify_content="center")[
        text(message, color=PICKER_HEADER_COLOR, font_size=PICKER_TEXT_SIZE)
    ]
...
def now_line(label, prefix="Now"):
    ...
    div, text = _elements()
    return div(flex_direction="row", align_items="flex_end", gap=10)[
        text(prefix, color=PICKER_HEADER_COLOR, font_size=PICKER_TEXT_SIZE),
...
def footer(tiles, note=None):
    ...
    return div(flex_direction="row", gap=PICKER_GAP, align_items="center")[
        *tiles,
        text(note, color=PICKER_HEADER_COLOR,
             font_size=PICKER_TEXT_SIZE) if note else None,
    ]
